...
def extract_training_unit_patches(
    ...
    tracker = UnitTracker(
        ...
        min_present_rois=min_present_rois,
        no_part_max_present_rois=no_part_max_present_rois,
        roi_roles=roi_roles or [],
        blue_presence_min=blue_presence_min,
        white_presence_min=white_presence_min,
    )
